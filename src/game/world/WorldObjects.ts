...
export const WORLD_OBJECTS: WorldObject[] = [
  ...
  },
  {
    ...
    futureDescription: 'A lively hub to meet other citizens, check in with Milo, and catch daily rumours.',
    futureIcon: '☕',
  },
  // ── Upper terrace / teal roofs ──
  {
    id: 'fame',
    displayName: 'Leaderboards & Hall of Fame',
    x: 0.1105,
    y: 0.3867,
    interactionRadius: 90,
    interactionType: 'leaderboard',
    futureDescription: "Monuments to the Top 3 weekly champions and all-time points legends.",
    futureIcon: '🏛️',
  },
  {
    id: 'government',
    displayName: 'Mission HQ',
    x: 0.1565,
    y: 0.1934,
    interactionRadius: 70,
    interactionType: 'discovery',
    futureDescription: 'Civic headquarters overseeing citywide mission directives and milestone certifications.',
    futureIcon: '🏙️',
  },
  {
    id: 'trading_academy',
  ...
  },
  {
    ...
    interactionType: 'discovery',
    futureDescription: 'The grand arena of RugTown. Timed challenges and tier trials are hosted here.',
    futureIcon: '🏟️',
  },
  // ── West / Southwest ──
  {
    ...
    interactionType: 'social',
    futureDescription: 'Alpha Club — a level-gated sanctuary for Level 30+ specialist missions, advanced lore, and higher-tier NPCs.',
    futureIcon: '🛋️',
  },
  {
    id: 'nft_gallery',
  ...
  },
  {
    ...
    interactionRadius: 90,
    interactionType: 'discovery',
    futureDescription: 'Quest Archive — discovered hidden quests, clues, and completed mission history.',
    futureIcon: '📜',
  },
];
